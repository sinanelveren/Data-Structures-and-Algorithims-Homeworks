 ...
 */
public class RedBlackTreeWorst<E extends Comparable<E>> extends BinarySearchTreeWithRotate<E> {
    ...
    /** Recursive add method.
     ...
     insertReturn is set false if item is already in the tree
     */
    ...
    /** Recursive remove from left sub-tree method.
     ...
     The object is removed from the tree
    ...
    /** Recursive remove from right sub-tree method.
     Removes the given object from the binary search tree.
     The values of parent and parent.right are not null
