...
public class MatrixGraph extends AbstractGraph {
    ...
    /**
     *  Two paramter constructor -- vertices and directionality
     ...
     * If an edge does not exist, an Edge with a weight of POSITIVE_INFINITY is returned.
    ...
    /** Return an iterator to the edges connected to a given vertix.
     * @param source - The source vertix
     * @return an EdgeIterator to the vertices contcted to source
     */
